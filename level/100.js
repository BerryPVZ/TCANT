			...
			(function (d) {
				...
				switch (d) {
					case 0:
						...
						c.innerHTML = '<span style="font-size:22px">Ah, sure is nice around here..</span>';
						break;
					case 1:
						PlaySound2("crazydavelong" + Math.floor(1 + Math.random() * 3));
						c.onclick = null;
						...
						c.innerHTML = '<span style="font-size:22px">Home sweet home-- WAIT THIS ISNT HOME!</span>';
						break;
					case 2:
						PlaySound2("crazydavelong" + Math.floor(1 + Math.random() * 3));
						c.onclick = null;
						...
						c.innerHTML = '<span style="font-size:22px">We are all the way at the Great Wall of China!</span>';
						break;
					case 3:
						PlaySound2("crazydavelong" + Math.floor(1 + Math.random() * 3));
						c.onclick = null;
						...
						c.innerHTML = '<span style="font-size:22px">HOW ARE WE GONNA GET THROUGH THIS??</span>';
						break;
					case 4:
						PlaySound2("crazydavelong" + Math.floor(1 + Math.random() * 3));
						c.onclick = null;
						...
						c.innerHTML = '<span style="font-size:22px">Oh, I know! Flower pots! they will help us alot! Imma go chill and eat freeze dried blueberries, <br> and I forgot to mention I gave you a new plant named ToughNut!</span>';
						break;
					case 5:
