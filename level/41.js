			...
			(function (d) {
				...
				switch (d) {
					case 0:
						...
						innerText(c, "Welcome to the Jiaxing river! The name roughly translates to the Shitpost river, so, this world only has one level and humor.");
						break;
					case 1:
						PlaySound2("crazydavelong" + Math.floor(1 + Math.random() * 3));
						c.onclick = null;
					...
					case 2:
						...
						innerText(c, "Look at the beautiful memes and the humor here!");
						break;
					case 3:
					...
					case 4:
						...
						innerText(c, "Good luck~ I went to eat Lil Berries.");
						break;
					case 5:
